...
let timeLockHour = [null, 19, 1, 22, 22, 1, 1];											// If time is locked, hour will be forever locked to this number.
let timeLockMinute = [null, 30, 0, 0, 0, 0, 0];											// If time is locked, the minute will be forever locked to this number.
let timeMinuteDuration = [null, 60000, 60000, 60000, 60000, 60000, 60000];

// ----------------------------------------------------------------------------

// Ambient Game Stuff
let trainsEnabled = [null, false, false, false, false, false, false];
let planesEnabled = [null, false, false, false, false, false, false];
let civiliansEnabled = [null, true, true, false, false, true, true];
let customCiviliansEnabled = [null, true, true, true, true, true, true];
let trafficEnabled = [null, false, false, false, false, false, false];
let trafficDensity = [null, 1, 1, 1, 1, 0, 0];
let civilianDensity = [null, 1, 1, 1, 1, 0, 0];
let ssvBridgeEnabled = [null, 1, 1, 1, 1, 0, 0];
