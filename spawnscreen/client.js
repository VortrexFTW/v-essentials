...
addEventHandler("OnDrawnHUD", function (event) {
	if(inSpawnScreen) {
		...
		if(skinSelectExplainFont != null) {
			let text = "Use LEFT/RIGHT to select a skin, and ENTER to spawn."
			let size = skinSelectExplainFont.measure(text, 200, 0.0, 1.0, 12, false, false);
